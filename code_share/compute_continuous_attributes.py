...
def comp_features(i):
    ...
    while j < len(st1[0].data) - stt*40:
        ...
        with open(f'/media/manuela/UNTITLED/illgraben/feature_files/{year}/40_seconds/{tt.julday}_{tt.hour}-{tt.minute}-{tt.second}.{tt.microsecond}.csv', "a+") as f:
...
[print(f'{i}') for i in pool.map(comp_features, range(201, 202))]
