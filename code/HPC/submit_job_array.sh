...
#SBATCH --array=65 # create a array from x to y and use it later with variable SLURM_ARRAY_TASK_ID. the numer after the %flag specifies how many jobs to start in parallel
#

#execute your script:
python comp_con_attributes_array.py "${SLURM_ARRAY_TASK_ID}"
